...
void Solution::outputCSV() {        // 输出csv
    ...
    head += "Objective 1,Objective 2,Objective 20,Objective 3,Objective 4";  // 表头
    ...
    for(auto solution: outputResult){
        ...
        outputSolution += to_string(solution.obj1) + "," + to_string(solution.obj2) + "," + to_string(solution.obj2 >> 41)
